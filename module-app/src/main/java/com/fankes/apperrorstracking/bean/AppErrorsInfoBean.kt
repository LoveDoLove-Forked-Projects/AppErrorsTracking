...
data class AppErrorsInfoBean(
     ...
     * @return [String]
     */
    fun crossTime(context: Context) = timestamp.difference(
        now = context.getString(R.string.moment_ago),
        second = context.getString(R.string.second_ago),
        minute = context.getString(R.string.minute_ago),
        hour = context.getString(R.string.hour_ago),
        day = context.getString(R.string.day_ago),
        month = context.getString(R.string.month_ago),
        year = context.getString(R.string.year_ago)
    )
